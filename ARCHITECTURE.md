...
This document describes the architecture of the Java Selenium MCP framework, built following Angie Jones' best practices and Model Context Protocol (MCP) principles for clean, modular, and AI-agent-friendly design.
